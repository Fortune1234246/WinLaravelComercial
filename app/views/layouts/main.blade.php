...
<head>
    ...
    <title>AutoVentas Mario Andrès</title>
        ...
        <nav class="navbar  navbar-default" role="navigation">
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <p class="navbar-text pull-right">Ya tienes cuenta? <a data-toggle="collapse" data-target="#login" class="navbar-link">Ingresar</a>
                    </p>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex5-collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="{{URL::to('/')}}">Inicio</a>
                            </li>
                            <li><a href="#">Agregar Auto</a>
                            </li>
                            <li><a href="#"></a>
                            </li>
                            <li><a href="#"></a>
